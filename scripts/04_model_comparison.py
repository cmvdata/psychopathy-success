...
# Compatibility shim: factor_analyzer <=0.5.1 calls sklearn.utils.check_array
# with the kwarg `force_all_finite`, which was renamed to `ensure_all_finite`
# in scikit-learn 1.6+. Patch the function before factor_analyzer imports it.
import sklearn
...
DATA_PATH_RAW  = ROOT / 'data' / 'PsychopathySuccess_dfFinal.txt'
DATA_PATH_PROC = ROOT / 'output' / 'df_processed.csv'
